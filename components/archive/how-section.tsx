      ...
      <div className="w-11/12 flex flex-col items-center justify-center mt-5 md:mt-0 gap-5 md:gap-0">
        <div className="flex flex-col md:flex-row items-center justify-center gap-5 md:gap-10">
          <div className="relative">
            <div className="font-extrabold inline-block text-saddlebrown-200">
              Scan the QR code{" "}
            </div>
            <div className="text-lgi leading-[130%] text-black inline-block">
              <p className="m-0">
                Scanning a QR code is an essential component of the user
                experience, providing convenience, seamless transitions between
                offline and online worlds, access to additional information or
                services, interactive and personalized experiences, and smooth
                interactions.
              </p>
              <p className="m-0">
                User will scan the QR code provided with the artworks that leads
                to the webpage for that artwork.
              </p>
            </div>
          </div>
          <img
        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-center gap-5 md:gap-10">
          ...
          <div className="relative">
            ...
            <div className="text-lgi leading-[130%] text-black inline-block">
              ...
              deeper into the provided information, resulting in a more engaging
