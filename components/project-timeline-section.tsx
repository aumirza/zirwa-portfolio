...
const TimelineCard = ({
  ...
  return (
    <div className="relative  flex justify-center w-48 lg:w-56 h-56 lg:h-64">
      <div className="p-10  z-20 h-full w-full flex flex-col gap-2 box-border items-center justify-center  bg-[url(/frame-294@3x.png)] bg-cover bg-no-repeat bg-[top]">
...
const ProjectTimelineSection = () => {
  return (
    <div className="w-full flex flex-col justify-center gap-10 text-dimgray-500">
      <div className="flex flex-row items-end justify-start gap-2 font-bold">
      ...
      <div className="hidden md:block relative">
        <div className="w-full grid grid-cols-10 grid-rows-2 gap-y-24 lg:gap-y-16">
        ...
        <div className="absolute top-1/2 bg-dimgray-100 h-3 w-full "></div>
      </div>
